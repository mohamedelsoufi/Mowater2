...
class RequestInspectionCenterResource extends JsonResource
{
    public function toArray($request)
    {
        ...
        if ($request->routeIs('inspection.show-request')) {
            $data["technical_inspection_center"] = $this->inspectionCenter;
        }
