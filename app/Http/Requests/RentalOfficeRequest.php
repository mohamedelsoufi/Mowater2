...
class RentalOfficeRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'description_en' => 'required|unique:rental_offices,description_en,'.$this->id,
            'description_ar' => 'required|unique:rental_offices,description_ar,'.$this->id,
            'tax_number' => 'required|unique:rental_offices,tax_number,'.$this->id,
