...
//            'ghamara_count' => ['required_if:vehicle_type,pickups'],
            ...
            'traveled_distance_type' => ['required_if:is_new,0', 'in:km,mile'],
            ...
            'guarantee' => ['required_if:is_new,0', 'boolean'],
            'guarantee_year' => ['required_if:guarantee,1', 'nullable', 'integer'],
            'guarantee_month' => ['required_if:is_new,0', 'required_if:guarantee,1', 'in:01,02,03,04,05,06,07,08,09,10,11,12'],
            ...
            'insurance' => ['required_if:is_new,0', 'boolean'],
            'insurance_month' => ['required_if:is_new,0', 'required_if:insurance,1', 'in:01,02,03,04,05,06,07,08,09,10,11,12'],
            ...
            'selling_by_plate' => ['required_if:is_new,0', 'boolean'],
            'number_plate' => ['required_if:selling_by_plate,1'],
            'price_is_negotiable' => ['required_if:is_new,0', 'boolean'],
