...
class ReserveInsuranceCompanyServiceRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'package_id'=>'required|exists:insurance_company_packages,id',
            ...
            'smart_card_front' => 'required|image|max:10000',
            'smart_card_back' => 'required|image|max:10000',
            'vehicle_ownership_front'=>'required|image|max:10000',
            'vehicle_ownership_back'=>'required|image|max:10000',
            'no_accident_certificate'=>'required_if:service_type,transfer_from_one_company_to_another|image|max:10000',
