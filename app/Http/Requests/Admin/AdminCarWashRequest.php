...
class AdminCarWashRequest extends FormRequest
{
    ...
    {
        return [
            'name_en' => 'required|unique:car_washes,name_en,'.$this->id,
            'name_ar' => 'required|unique:car_washes,name_ar,'.$this->id,
            'description_en' => 'nullable',
            'description_ar' => 'nullable',
            'address' => 'nullable',
            'tax_number' => 'unique:car_washes,tax_number,'.$this->id,
