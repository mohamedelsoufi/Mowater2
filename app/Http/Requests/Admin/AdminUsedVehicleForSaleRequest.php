...
class AdminUsedVehicleForSaleRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'chassis_number' => 'required_without:id|unique:vehicles,chassis_number,'.$this->id,
            'traveled_distance' => ['required_without:id', 'nullable', 'numeric', 'between:0,999999999999999.99'],
            'traveled_distance_type' => ['required_without:id', 'in:km,mile'],
            'outside_color_id' => 'nullable|exists:colors,id',
            'inside_color_id' => 'nullable|exists:colors,id',
            'in_bahrain' => ['required_without:id', 'boolean'],
            'country_id' => ['required_if:in_bahrain,0', 'nullable', 'exists:countries,id'],
            'guarantee' => ['required_without:id', 'boolean'],
            ...
            'fuel_type' => 'required_without:id|in:' . fuel_type(),
            'wheel_drive_system' => 'nullable|in:' . wheel_drive_system(),
            'specifications' => 'nullable|in:' . specifications(),
            'status' => ['required_without:id', 'in:' . status()],
            'insurance' => ['required_without:id', 'boolean'],
            ...
            'selling_by_plate' => ['required_without:id', 'boolean'],
            'number_plate' => ['required_if:selling_by_plate,1'],
            'price_is_negotiable' => 'required_without:id|boolean',
            'location' => 'nullable|string',
            'additional_notes' => 'nullable',
            'price' => 'required|between:0,9999999999.99',
            'front_side_image' => 'required_without:id|image|max:10000',
            'back_side_image' => 'required_without:id|image|max:10000',
            'right_side_image' => 'required_without:id|image|max:10000',
            'left_side_image' => 'required_without:id|image|max:10000',
            'inside_vehicle_image' => 'required_without:id|image|max:10000',
            'vehicle_dashboard_image' => 'required_without:id|image|max:10000',
            'traffic_pdf' => 'required_without:id|mimes:pdf',
        ];
    }
}
