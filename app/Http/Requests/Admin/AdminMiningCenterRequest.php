...
class AdminMiningCenterRequest extends FormRequest
{
    ...
    {
        return [
            'name_en' => 'required|unique:mining_centers,name_en,'.$this->id,
            'name_ar' => 'required|unique:mining_centers,name_ar,'.$this->id,
            'description_en' => 'nullable',
            'description_ar' => 'nullable',
            'address' => 'nullable',
            'tax_number' => 'unique:mining_centers,tax_number,'.$this->id,
