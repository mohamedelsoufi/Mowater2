...
class RentalOfficeCar extends Model
{
    ...
    protected $appends = ['one_image','daily_price_after_discount','monthly_price_after_discount',
        'weekly_price_after_discount','yearly_price_after_discount'];
    ...
    public function getDailyPriceAfterDiscountAttribute()
    {
    ...
    public function getWeeklyPriceAfterDiscountAttribute()
    {
        if ($this->discount != null) {
            $discount_type = $this->discount_type;
            $percentage_value = ((100 - $this->discount) / 100);
    ...
    public function getMonthlyPriceAfterDiscountAttribute()
    {
        if ($this->discount != null) {
            $discount_type = $this->discount_type;
            $percentage_value = ((100 - $this->discount) / 100);
    ...
    public function getYearlyPriceAfterDiscountAttribute()
    {
        if ($this->discount != null) {
            $discount_type = $this->discount_type;
            $percentage_value = ((100 - $this->discount) / 100);
