...
class MiningCenterService extends Model
{
    use HasFactory, HasFiles, HasAds;

    protected $table = 'mining_center_services';

    protected $fillable = ['id', 'mining_center_id', 'name_en', 'name_ar', 'description_en'
    ...
    //relationship start
    public function miningCenter()
    {
        return $this->belongsTo(MiningCenter::class, 'mining_center_id');
    }
