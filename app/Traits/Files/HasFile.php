...
trait HasFile
{
    ...
    public function getTrainerVehicleAttribute()
    {
        return $this->file()->where('type','trainer_vehicle')->first() ?  $this->file()->where('type','trainer_vehicle')->first()->path : asset('uploads/default_image.png');
    }
}
