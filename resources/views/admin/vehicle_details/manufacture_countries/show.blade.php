...
@section('title', __('words.show_manufacture_country'))
@section('content')
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb {{app()->getLocale() == 'ar' ? 'float-sm-left' :  'float-sm-right'}}">
                            ...
                            <li class="breadcrumb-item"><a
                                    href="{{route('manufacture-countries.index')}}">{{__('words.show_manufacture_countries')}}</a>
                            </li>
                            <li class="breadcrumb-item active">{{__('words.show_manufacture_country')}}</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
