<form action="{{route('sub-categories.destroy',$sub_category->id)}}"
    ...
    {{ csrf_field() }}
    {{ method_field('delete') }}
    <div class="modal fade" id="ModalDelete{{$sub_category->id}}" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body"> {{ __('message.delete_message') }} <b class="text-danger">{{ $sub_category->name }}</b></div>
