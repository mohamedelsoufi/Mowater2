<form action="{{route('cities.destroy',$city->id)}}"
    ...
    {{ csrf_field() }}
    {{ method_field('delete') }}
    <div class="modal fade" id="ModalDelete{{$city->id}}" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body"> {{ __('message.delete_message') }} <b class="text-danger">{{ $city->name }}</b></div>
