...
@section('title', __('words.new_rental_office'))
@section('content')
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb {{app()->getLocale() == 'ar' ? 'float-sm-left' :  'float-sm-right'}}">
                            ...
                            <li class="breadcrumb-item active">{{__('words.new_rental_office')}}</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        ...
                        <div class="card card-danger">
                            <div class="card-header">
                                <h3 class="card-title">{{__('words.new_rental_office')}}</h3>
                            </div>
                            <form action="{{route('rental-offices.store')}}" method="POST" autocomplete="off"
