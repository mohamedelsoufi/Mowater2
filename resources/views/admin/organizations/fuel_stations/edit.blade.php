                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card card-danger">
                            ...
                            <form method="post"
                                  action="{{route('fuel-stations.update',$fuel_station->id)}}"
                                  autocomplete="off"
                                  enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <input type="hidden" name="id" value="{{$fuel_station->id}}">
                                <div class="card-body">
                                    <div class="basic-form">
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="name_ar"
                                                       ...
                                                       value="{{ old('name_ar',$fuel_station->name_ar) }}"
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <textarea name="address_ar"
                                                          class="form-control @error('address_ar') is-invalid @enderror">{{ old('address_ar',$fuel_station->address_ar) }}</textarea>
                                        ...
                                        <hr>
                                        <h5>{{__('words.fuel_types')}}</h5>
{{--                                        {{dd($fuel_station->fuel_types)}}--}}
                                        <div class="form-row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                               name="fuel_types[]"
                                                               value="super" {{in_array('super',$fuel_station->fuel_types)  ? 'checked' : ''}}>
                                                        <label for="super"
                                                               class="form-check-label">{{__('words.super')}}</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                               name="fuel_types[]"
                                                               value="excellent" {{in_array('excellent',$fuel_station->fuel_types)  ? 'checked' : ''}}>
                                                        <label for="excellent"
                                                               class="form-check-label">{{__('words.excellent')}}</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                               name="fuel_types[]"
                                                               value="good" {{in_array('good',$fuel_station->fuel_types)  ? 'checked' : ''}}>
                                                        <label for="good"
                                                               class="form-check-label">{{__('words.good')}}</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                               name="fuel_types[]"
                                                               value="Diesel" {{in_array('Diesel',$fuel_station->fuel_types)  ? 'checked' : ''}}>
                                                        <label for="Diesel"
                                                               class="form-check-label">{{__('words.Diesel')}}</label>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-4 text-center pt-3">
                                                <img src="{{ old('logo',$fuel_station->logo) }}"
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="latitude"
                                                       ...
                                                       value="{{ old('latitude',$fuel_station->latitude) }}"
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="longitude"
                                                       ...
                                                       value="{{ old('longitude',$fuel_station->longitude) }}"
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <select name="country_id"
                                                    ...
                                                    @foreach($countries as $country)
                                                        ...
                                                        @else
                                                            <option
                                                                value="{{$country->id}}" {{$fuel_station->country_id == $country->id ? "selected" : ""}}>{{$country->name}}</option>
                                                        @endif
                                                    @endforeach
                                                </select>
                                                @error('country_id')
                                            ...
                                            <div class="form-group col-md-3">
                                                <div class="form-check">
                                                    <input class="form-check-input" name="active" value="0"
                                                           {{$fuel_station->active == 1 ? 'checked' : ''}} type="checkbox">
                                            ...
                                            <div class="form-group col-md-3">
                                                <div class="form-check">
                                                    <input class="form-check-input" name="active_number_of_views"
                                                           value="0"
                                                           {{$fuel_station->active_number_of_views == 1 ? 'checked' : ''}} type="checkbox">
                                                    <label class="form-check-label">
...
@section('scripts')
    <script>
        $(document).ready(function () {
            get_cities("{{$fuel_station->country_id}}", "{{$fuel_station->city_id}}", "{{$fuel_station->area_id}}");
            get_areas("{{$fuel_station->city_id}}", "{{$fuel_station->area_id}}");

            let url = "{{route('fuel-station.users' , ':id')}}";
            url = url.replace(':id', "{{$fuel_station->id}}");
            $.ajax({
                type: "Get",
                url: url,
                datatype: 'JSON',
        ...
        $('.email-change').on('change', function () {
            ...
            let get_user_url = "{{route('fuel-station.user',[$fuel_station->id,':user'])}}";
