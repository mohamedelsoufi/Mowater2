...
@section('title', __('words.new_fuel_station'))
@section('content')
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb {{app()->getLocale() == 'ar' ? 'float-sm-left' :  'float-sm-right'}}">
                            ...
                            <li class="breadcrumb-item active">{{__('words.new_fuel_station')}}</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        ...
                        <div class="card card-danger">
                            <div class="card-header">
                                <h3 class="card-title">{{__('words.new_fuel_station')}}</h3>
                            </div>
                            <form action="{{route('fuel-stations.store')}}" method="POST" autocomplete="off"
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-3">
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" name="fuel_types[]"
                                                           value="super">
                                                    <label for="super"
