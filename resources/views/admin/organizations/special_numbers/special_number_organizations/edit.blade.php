...
@section('title', __('words.edit_special_number_organization'))
@section('content')
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb {{app()->getLocale() == 'ar' ? 'float-sm-left' :  'float-sm-right'}}">
                            ...
                            <li class="breadcrumb-item active">{{__('words.edit_special_number_organization')}}</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        <div class="card card-danger">
                            <div class="card-header">
                                <h3 class="card-title">{{__('words.edit_special_number_organization')}}</h3>
                            </div>
                            <form method="post"
                                  action="{{route('special-number-organizations.update',$organization->id)}}"
                                  autocomplete="off"
                                    ...
                                    <div class="basic-form">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <textarea name="description_ar" dir="rtl"
                                                          class="form-control @error('description_ar') is-invalid @enderror">{{ old('description_ar',$organization->description_ar) }}</textarea>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <textarea name="description_en" dir="ltr"
                                                          class="form-control @error('description_en') is-invalid @enderror">{{ old('description_en',$organization->description_en) }}</textarea>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-6 text-center pt-3">
                                                <img src="{{ old('logo',$organization->logo) }}"
...
@section('scripts')
    <script>
        ...
        $('.email-change').on('change', function () {
            ...
            let get_user_url = "{{route('special-org.user',[$organization->id,':user'])}}";
