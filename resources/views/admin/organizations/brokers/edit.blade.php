...
@section('title', __('words.edit_broker'))
@section('content')
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb {{app()->getLocale() == 'ar' ? 'float-sm-left' :  'float-sm-right'}}">
                            ...
                            <li class="breadcrumb-item active">{{__('words.edit_broker')}}</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        <div class="card card-danger">
                            <div class="card-header">
                                <h3 class="card-title">{{__('words.edit_broker')}}</h3>
                            </div>
                            <form method="post"
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="name_ar" dir="rtl"
                                                       ...
                                                       value="{{ old('name_ar',$broker->name_ar) }}"
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="name_en" dir="ltr"
                                                       ...
                                                       value="{{ old('name_en',$broker->name_en) }}"
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <textarea name="description_ar" dir="rtl"
                                                          class="form-control @error('description_ar') is-invalid @enderror">{{ old('description_ar',$broker->description_ar) }}</textarea>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <textarea name="description_en" dir="ltr"
                                                          class="form-control @error('description_en') is-invalid @enderror">{{ old('description_en',$broker->description_en) }}</textarea>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="tax_number"
                                                       ...
                                                       value="{{ old('tax_number',$broker->tax_number) }}"
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="year_founded"
                                                       ...
                                                       value="{{ old('year_founded',$broker->year_founded) }}"
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <select name="country_id"
                                                    ...
                                                    @foreach($countries as $country)
                                                        ...
                                                        @else
                                                            <option
                                                                value="{{$country->id}}" {{$broker->country_id == $country->id ? "selected" : ""}}>{{$country->name}}</option>
                                                        @endif
                                                    @endforeach
                                                </select>
                                                @error('country_id')
                                            ...
                                            <div class="form-group col-md-4">
                                                <div class="form-check">
                                                    <input class="form-check-input" name="active" value="0"
                                                           {{$broker->active == 1 ? 'checked' : ''}} type="checkbox">
                                            ...
                                            <div class="form-group col-md-4">
                                                <div class="form-check">
                                                    <input class="form-check-input" name="active_number_of_views"
                                                           value="0"
                                                           {{$broker->active_number_of_views == 1 ? 'checked' : ''}} type="checkbox">
                                                    <label class="form-check-label">
                                            ...
                                            <div class="form-group col-md-4">
                                                <div class="form-check">
                                                    <input class="form-check-input" name="reservation_active" value="0"
                                                           {{$broker->reservation_active == 1 ? 'checked' : ''}} type="checkbox">
                                                    <label class="form-check-label">
...
@section('scripts')
    <script>
        $(document).ready(function () {
            get_cities("{{$broker->country_id}}", "{{$broker->city_id}}", "{{$broker->area_id}}");
            get_areas("{{$broker->city_id}}", "{{$broker->area_id}}");


            let url = "{{route('broker.users' , ':id')}}"
            url = url.replace(':id', "{{$broker->id}}");
            $.ajax({
                type: "Get",
                url: url,
                datatype: 'JSON',
        ...
        $('.email-change').on('change', function () {
            ...
            let get_user_url = "{{route('broker.user',[$broker->id,':user'])}}";
