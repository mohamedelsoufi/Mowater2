...
@section('title', __('words.edit_driving_trainer'))
@section('content')
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb {{app()->getLocale() == 'ar' ? 'float-sm-left' :  'float-sm-right'}}">
                            ...
                            <li class="breadcrumb-item active">{{__('words.edit_driving_trainer')}}</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        <div class="card card-danger">
                            <div class="card-header">
                                <h3 class="card-title">{{__('words.edit_driving_trainer')}}</h3>
                            </div>
                            <form method="post"
                                ...
                                <div class="card-body">
                                    <div class="basic-form">
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="name_ar"
                                                       ...
                                                       value="{{ old('name_ar',$trainer->name_ar) }}"
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="name_en" dir="ltr"
                                                       ...
                                                       value="{{ old('name_en',$trainer->name_en) }}"
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <textarea name="description_ar"
                                                          class="form-control @error('description_ar') is-invalid @enderror">{{ old('description_ar',$trainer->description_ar) }}</textarea>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <textarea name="description_en" dir="ltr"
                                                          class="form-control @error('description_en') is-invalid @enderror">{{ old('description_en',$trainer->description_en) }}</textarea>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <select name="gender"
                                                    ...
                                                    <option
                                                        value="male" {{ $trainer->gender == "male" ? "selected" : "" }} >{{__('words.male')}}</option>
                                                    <option
                                                        value="female" {{ $trainer->gender == "female" ? "selected" : "" }}>{{__('words.female')}}</option>
                                                </select>
                                                @error('gender')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="input-group date" id="reservationdate"
                                                    ...
                                                    <input type="text" class="form-control datetimepicker-input"
                                                           value="{{$trainer->birth_date}}" name="birth_date"
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-6 text-center pt-3">
                                                <img src="{{ $trainer->trainer_vehicle != null ? $trainer->trainer_vehicle : asset('uploads/default_image.png')  }}"
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <select name="brand_id"
                                                    ...
                                                    @foreach($brands as $brand)
                                                        ...
                                                        @else
                                                            <option
                                                                value="{{$brand->id}}" {{$trainer->brand_id == $brand->id ? 'selected' : ''}}>{{$brand->name}}</option>
                                                        @endif
                                                    @endforeach
                                                </select>
                                                @error('brand_id')
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <select name="car_class_id"
                                                    ...
                                                    @foreach($car_classes as $car_class)
                                                        ...
                                                        @else
                                                            <option
                                                                value="{{$car_class->id}}" {{$trainer->car_class_id == $car_class->id ? 'selected' : ''}}>{{$car_class->name}}</option>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-4">
                                                ...
                                                <select name="vehicle_type"
                                                    ...
                                                    <option value="" selected>{{__('words.choose')}}</option>
                                                    <option
                                                        value="cars" {{old('vehicle_type') || $trainer->vehicle_type == "cars" ? "selected" : ""}}>{{__('vehicle.cars')}}</option>
                                                    <option
                                                        value="motorcycles" {{old('vehicle_type') || $trainer->vehicle_type == "motorcycles" ? "selected" : ""}}>{{__('vehicle.motorcycles')}}</option>
                                                    <option
                                                        value="pickups" {{old('vehicle_type') || $trainer->vehicle_type == "pickups" ? "selected" : ""}}>{{__('vehicle.pickups')}}</option>
                                                </select>
                                                @error('vehicle_type')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <select name="conveyor_type"
                                                    ...
                                                    @foreach(transmission_type_arr() as $key => $value)
                                                        <option
                                                            value="{{$key}}" {{$trainer->conveyor_type == $key ? "selected" : ""}}>{{$value}}</option>
                                                    @endforeach
                                                </select>
                                                @error('conveyor_type')
                                                <span class="invalid-feedback" role="alert">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" name="manufacturing_year"
                                                       ...
                                                       value="{{ old('manufacturing_year',$trainer->manufacturing_year) }}"
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <select name="country_id"
                                                    ...
                                                    @foreach($countries as $country)
                                                        ...
                                                        @else
                                                            <option
                                                                value="{{$country->id}}" {{$trainer->country_id == $country->id ? "selected" : ""}}>{{$country->name}}</option>
                                                        @endif
                                                    @endforeach
                                                </select>
                                                @error('country_id')
                                            ...
                                            <div class="form-group col-md-6">
                                                <div class="form-check">
                                                    <input class="form-check-input" name="active" value="0"
                                                           type="checkbox" {{$trainer->active == 1 ? "checked" : ""}}>
                                            ...
                                            <div class="form-group col-md-6">
                                                <div class="form-check">
                                                    <input class="form-check-input" name="active_number_of_views"
                                                           value="0"
                                                           type="checkbox" {{$trainer->active_number_of_views == 1 ? "checked" : ""}}>
                                                    <label class="form-check-label">
...
@section('scripts')
    ...
    <script>
        $(document).ready(function () {
            if("{{$trainer->brand_id != null}}"){
                get_models("{{$trainer->brand_id}}", "{{$trainer->car_model_id}}");
            }
            get_cities("{{$trainer->country_id}}", "{{$trainer->city_id}}", "{{$trainer->area_id}}");
            get_areas("{{$trainer->city_id}}", "{{$trainer->area_id}}");


            let url = "{{route('trainer.users' , ':id')}}";
        ...
        $('.email-change').on('change', function () {
            ...
            let get_user_url = "{{route('trainer.user',[$trainer->id,':user'])}}";
