...
@section('title', __('words.edit_garage'))
@section('content')
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb {{app()->getLocale() == 'ar' ? 'float-sm-left' :  'float-sm-right'}}">
                            ...
                            <li class="breadcrumb-item"><a
                                    href="{{route('garages.index')}}">{{__('words.show_garages')}}</a>
                            </li>
                            <li class="breadcrumb-item active">{{__('words.edit_garage')}}</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        <div class="card card-danger">
                            <div class="card-header">
                                <h3 class="card-title">{{__('words.edit_garage')}}</h3>
                            </div>
                            <form method="post"
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="name_ar"
                                                       ...
                                                       value="{{ old('name_ar',$garage->name_ar) }}"
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="name_en"
                                                       ...
                                                       value="{{ old('name_en',$garage->name_en) }}"
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <textarea name="description_ar"
                                                          class="form-control @error('description_ar') is-invalid @enderror">{{ old('description_ar',$garage->description_ar) }}</textarea>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <textarea name="description_en"
                                                          class="form-control @error('description_en') is-invalid @enderror">{{ old('description_en',$garage->description_en) }}</textarea>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="tax_number"
                                                       ...
                                                       value="{{ old('tax_number',$garage->tax_number) }}"
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="year_founded"
                                                       ...
                                                       value="{{ old('year_founded',$garage->year_founded) }}"
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <select name="country_id"
                                                    ...
                                                    @foreach($countries as $country)
                                                        ...
                                                        @else
                                                            <option
                                                                value="{{$country->id}}" {{$garage->country_id == $country->id ? "selected" : ""}}>{{$country->name}}</option>
                                                        @endif
                                                    @endforeach
                                                </select>
                                                @error('country_id')
                                            ...
                                            <div class="form-group col-md-3">
                                                <div class="form-check">
                                                    <input class="form-check-input" name="active" value="0"
                                                           {{$garage->active == 1 ? 'checked' : ''}} type="checkbox">
                                            ...
                                            <div class="form-group col-md-3">
                                                <div class="form-check">
                                                    <input class="form-check-input" name="active_number_of_views"
                                                           value="0"
                                                           {{$garage->active_number_of_views == 1 ? 'checked' : ''}} type="checkbox">
                                                    <label class="form-check-label">
                                            ...
                                            <div class="form-group col-md-3">
                                                <div class="form-check">
                                                    <input class="form-check-input" name="reservation_active" value="0"
                                                           {{$garage->reservation_active == 1 ? 'checked' : ''}} type="checkbox">
                                                    <label class="form-check-label">
                                            ...
                                            <div class="form-group col-md-3">
                                                <div class="form-check">
                                                    <input class="form-check-input" name="delivery_active" value="0"
                                                           {{$garage->delivery_active == 1 ? 'checked' : ''}} type="checkbox">
                                                    <label class="form-check-label">
...
@section('scripts')
    <script>
        $(document).ready(function () {
            get_cities("{{$garage->country_id}}", "{{$garage->city_id}}", "{{$garage->area_id}}");
            get_areas("{{$garage->city_id}}", "{{$garage->area_id}}");

            let url = "{{route('garage.users' , ':id')}}"
            url = url.replace(':id', "{{$garage->id}}");
            $.ajax({
                type: "Get",
                url: url,
                datatype: 'JSON',
        ...
        $('.email-change').on('change', function () {
            ...
            let get_user_url = "{{route('garage.user',[$garage->id,':user'])}}";
