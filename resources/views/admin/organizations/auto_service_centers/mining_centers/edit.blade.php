...
@section('title', __('words.edit_mining_center'))
@section('content')
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb {{app()->getLocale() == 'ar' ? 'float-sm-left' :  'float-sm-right'}}">
                            ...
                            <li class="breadcrumb-item active">{{__('words.edit_mining_center')}}</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        <div class="card card-danger">
                            <div class="card-header">
                                <h3 class="card-title">{{__('words.edit_mining_center')}}</h3>
                            </div>
                            <form method="post"
                                  action="{{route('mining-centers.update',$mining_center->id)}}"
                                  autocomplete="off"
                                  enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <input type="hidden" name="id" value="{{$mining_center->id}}">
                                <div class="card-body">
                                    <div class="basic-form">
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="name_ar"
                                                       ...
                                                       value="{{ old('name_ar',$mining_center->name_ar) }}"
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="name_en" dir="ltr"
                                                       ...
                                                       value="{{ old('name_en',$mining_center->name_en) }}"
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <textarea name="description_ar"
                                                          class="form-control @error('description_ar') is-invalid @enderror">{{ old('description_ar',$mining_center->description_ar) }}</textarea>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <textarea name="description_en" dir="ltr"
                                                          class="form-control @error('description_en') is-invalid @enderror">{{ old('description_en',$mining_center->description_en) }}</textarea>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-6 text-center pt-3">
                                                <img src="{{ old('logo',$mining_center->logo) }}"
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <textarea name="address"
                                                          class="form-control @error('address') is-invalid @enderror">{{ old('address',$mining_center->address) }}</textarea>
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="tax_number"
                                                       ...
                                                       value="{{ old('tax_number',$mining_center->tax_number) }}"
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <select name="city_id"
                                                    ...
                                                    @foreach($cities as $model)
                                                        ...
                                                        @else
                                                            <option value="{{ $model->id }}"  {{ $mining_center->city_id == $model->id ? "selected" : "" }}>
                                                                {{ $model->name }}
                                                            </option>
                                                        @endif
                                                    @endforeach
                                            ...
                                            <div class="form-group col-md-6">
                                                <div class="form-check">
                                                    <input class="form-check-input" name="active" value="0"
                                                           {{$mining_center->active == 1 ? 'checked' : ''}} type="checkbox">
                                            ...
                                            <div class="form-group col-md-6">
                                                <div class="form-check">
                                                    <input class="form-check-input" name="active_number_of_views"
                                                           value="0"
                                                           {{$mining_center->active_number_of_views == 1 ? 'checked' : ''}} type="checkbox">
                                                    <label class="form-check-label">
...
@section('scripts')
    <script>
        $(document).ready(function () {
            let url = "{{route('mining-center.users' , ':id')}}";
            url = url.replace(':id', "{{$mining_center->id}}");
            $.ajax({
                type: "Get",
                url: url,
                datatype: 'JSON',
        ...
        $('.email-change').on('change', function () {
            ...
            let get_user_url = "{{route('mining-center.user',[$mining_center->id,':user'])}}";
