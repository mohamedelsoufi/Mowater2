                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card card-danger">
                            ...
                            <form method="post"
                                  action="{{route('accessories-stores.update',$store->id)}}"
                                  autocomplete="off"
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="name_en"
                                                       ...
                                                       value="{{ old('name_en',$store->name_en) }}"
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <textarea name="description_ar"
                                                          class="form-control @error('description_ar') is-invalid @enderror">{{ old('description_ar',$store->description_ar) }}</textarea>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <textarea name="description_en"
                                                          class="form-control @error('description_en') is-invalid @enderror">{{ old('description_en',$store->description_en) }}</textarea>
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <select name="city_id"
                                                    ...
                                                    @foreach($cities as $model)
                                                        ...
                                                        @else
                                                            <option value="{{ $model->id }}"  {{ $store->city_id == $model->id ? "selected" : "" }}>
                                                                {{ $model->name }}
                                                            </option>
                                                        @endif
                                                    @endforeach
                                            ...
                                            <div class="form-group col-md-3">
                                                <div class="form-check">
                                                    <input class="form-check-input" name="active" value="0"
                                                           {{$store->active == 1 ? 'checked' : ''}} type="checkbox">
                                            ...
                                            <div class="form-group col-md-3">
                                                <div class="form-check">
                                                    <input class="form-check-input" name="active_number_of_views"
                                                           value="0"
                                                           {{$store->active_number_of_views == 1 ? 'checked' : ''}} type="checkbox">
                                                    <label class="form-check-label">
                                            ...
                                            <div class="form-group col-md-3">
                                                <div class="form-check">
                                                    <input class="form-check-input" name="reservation_active" value="0"
                                                           {{$store->reservation_active == 1 ? 'checked' : ''}} type="checkbox">
                                                    <label class="form-check-label">
                                            ...
                                            <div class="form-group col-md-3">
                                                <div class="form-check">
                                                    <input class="form-check-input" name="delivery_active" value="0"
                                                           {{$store->delivery_active == 1 ? 'checked' : ''}} type="checkbox">
                                                    <label class="form-check-label">
...
@section('scripts')
    <script>
        $(document).ready(function () {
            let url = "{{route('accessories.users' , ':id')}}";
        ...
        $('.email-change').on('change', function () {
            ...
            let get_user_url = "{{route('accessories.user',[$store->id,':user'])}}";
