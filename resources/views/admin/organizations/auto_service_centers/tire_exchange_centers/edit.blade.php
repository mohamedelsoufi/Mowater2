...
@section('title', __('words.edit_tire_exchange_center'))
@section('content')
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb {{app()->getLocale() == 'ar' ? 'float-sm-left' :  'float-sm-right'}}">
                            ...
                            <li class="breadcrumb-item"><a
                                    href="{{route('tire-exchange-centers.index')}}">{{__('words.show_tire_exchange_centers')}}</a>
                            </li>
                            <li class="breadcrumb-item active">{{__('words.edit_tire_exchange_center')}}</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        <div class="card card-danger">
                            <div class="card-header">
                                <h3 class="card-title">{{__('words.edit_tire_exchange_center')}}</h3>
                            </div>
                            <form method="post"
                                  action="{{route('tire-exchange-centers.update',$center->id)}}"
                                  autocomplete="off"
...
@section('scripts')
    <script>
        $(document).ready(function () {
            let url = "{{route('tire-exchange.users' , ':id')}}";
        ...
        $('.email-change').on('change', function () {
            ...
            let get_user_url = "{{route('tire-exchange.user',[$center->id,':user'])}}";
