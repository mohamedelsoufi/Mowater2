...
@section('title', __('words.edit_technical_inspection_center'))
@section('content')
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb {{app()->getLocale() == 'ar' ? 'float-sm-left' :  'float-sm-right'}}">
                            ...
                            <li class="breadcrumb-item"><a
                                    href="{{route('inspection-centers.index')}}">{{__('words.show_technical_inspection_centers')}}</a>
                            </li>
                            <li class="breadcrumb-item active">{{__('words.edit_technical_inspection_center')}}</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        <div class="card card-danger">
                            <div class="card-header">
                                <h3 class="card-title">{{__('words.edit_technical_inspection_center')}}</h3>
                            </div>
                            <form method="post"
                                  action="{{route('inspection-centers.update',$center->id)}}"
                                  autocomplete="off"
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="name_ar" dir="rtl"
                                                       ...
                                                       value="{{ old('name_ar',$center->name_ar) }}"
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <textarea name="description_ar" dir="rtl"
                                                          class="form-control @error('description_ar') is-invalid @enderror">{{ old('description_ar',$center->description_ar) }}</textarea>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <textarea name="description_en" dir="ltr"
                                                          class="form-control @error('description_en') is-invalid @enderror">{{ old('description_en',$center->description_en) }}</textarea>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <textarea name="address"
                                                          class="form-control @error('address') is-invalid @enderror">{{ old('address',$center->address) }}</textarea>
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="tax_number"
                                                       ...
                                                       value="{{ old('tax_number',$center->tax_number) }}"
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <select name="city_id"
                                                    ...
                                                    @foreach($cities as $model)
                                                        ...
                                                        @else
                                                            <option value="{{ $model->id }}"  {{ $center->city_id == $model->id ? "selected" : "" }}>
                                                                {{ $model->name }}
                                                            </option>
                                                        @endif
                                                    @endforeach
                                            ...
                                            <div class="form-group col-md-4">
                                                <div class="form-check">
                                                    <input class="form-check-input" name="active" value="0"
                                                           {{$center->active == 1 ? 'checked' : ''}} type="checkbox">
                                            ...
                                            <div class="form-group col-md-4">
                                                <div class="form-check">
                                                    <input class="form-check-input" name="active_number_of_views"
                                                           value="0"
                                                           {{$center->active_number_of_views == 1 ? 'checked' : ''}} type="checkbox">
                                                    <label class="form-check-label">
                                            ...
                                            <div class="form-group col-md-4">
                                                <div class="form-check">
                                                    <input class="form-check-input" name="reservation_active" value="0"
                                                           {{$center->reservation_active == 1 ? 'checked' : ''}} type="checkbox">
                                                    <label class="form-check-label">
...
@section('scripts')
    <script>
        $(document).ready(function () {
            let url = "{{route('inspection.users' , ':id')}}";
        ...
        $('.email-change').on('change', function () {
            ...
            let get_user_url = "{{route('inspection.user',[$center->id,':user'])}}";
