...
@section('title', __('words.edit_insurance_company'))
@section('content')
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb {{app()->getLocale() == 'ar' ? 'float-sm-left' :  'float-sm-right'}}">
                            ...
                            <li class="breadcrumb-item"><a
                                    href="{{route('insurance_companies.index')}}">{{__('words.show_insurance_companies')}}</a>
                            </li>
                            <li class="breadcrumb-item active">{{__('words.edit_insurance_company')}}</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        <div class="card card-danger">
                            <div class="card-header">
                                <h3 class="card-title">{{__('words.edit_insurance_company')}}</h3>
                            </div>
                            <form method="post"
                                  action="{{route('insurance_companies.update',$insurance_company->id)}}"
                                  autocomplete="off"
                                  enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <input type="hidden" name="id" value="{{$insurance_company->id}}">
                                <div class="card-body">
                                    <div class="basic-form">
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="name_ar"
                                                       ...
                                                       value="{{ old('name_ar',$insurance_company->name_ar) }}"
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="name_en" dir="ltr"
                                                       ...
                                                       value="{{ old('name_en',$insurance_company->name_en) }}"
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <textarea name="description_ar"
                                                          class="form-control @error('description_ar') is-invalid @enderror">{{ old('description_ar',$insurance_company->description_ar) }}</textarea>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <textarea name="description_en" dir="ltr"
                                                          class="form-control @error('description_en') is-invalid @enderror">{{ old('description_en',$insurance_company->description_en) }}</textarea>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-6 text-center pt-3">
                                                <img src="{{ old('logo',$insurance_company->logo) }}"
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="tax_number"
                                                       ...
                                                       value="{{ old('tax_number',$insurance_company->tax_number) }}"
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="year_founded"
                                                       ...
                                                       value="{{ old('year_founded',$insurance_company->year_founded) }}"
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <select name="country_id"
                                                    ...
                                                    @foreach($countries as $country)
                                                        ...
                                                        @else
                                                            <option
                                                                value="{{$country->id}}" {{$insurance_company->country_id == $country->id ? "selected" : ""}}>{{$country->name}}</option>
                                                        @endif
                                                    @endforeach
                                                </select>
                                                @error('country_id')
                                            ...
                                            <div class="form-group col-md-4">
                                                <div class="form-check">
                                                    <input class="form-check-input" name="active" value="0"
                                                           {{$insurance_company->active == 1 ? 'checked' : ''}} type="checkbox">
                                            ...
                                            <div class="form-group col-md-4">
                                                <div class="form-check">
                                                    <input class="form-check-input" name="active_number_of_views"
                                                           value="0"
                                                           {{$insurance_company->active_number_of_views == 1 ? 'checked' : ''}} type="checkbox">
                                                    <label class="form-check-label">
                                            ...
                                            <div class="form-group col-md-4">
                                                <div class="form-check">
                                                    <input class="form-check-input" name="reservation_active" value="0"
                                                           {{$insurance_company->reservation_active == 1 ? 'checked' : ''}} type="checkbox">
                                                    <label class="form-check-label">
...
@section('scripts')
    <script>
        $(document).ready(function () {
            get_cities("{{$insurance_company->country_id}}", "{{$insurance_company->city_id}}", "{{$insurance_company->area_id}}");
            get_areas("{{$insurance_company->city_id}}", "{{$insurance_company->area_id}}");

            let url = "{{route('insurance.users' , ':id')}}"
            url = url.replace(':id', "{{$insurance_company->id}}");
            $.ajax({
                type: "Get",
                url: url,
                datatype: 'JSON',
        ...
        $('.email-change').on('change', function () {
            ...
            let get_user_url = "{{route('insurance.user',[$insurance_company->id,':user'])}}";
