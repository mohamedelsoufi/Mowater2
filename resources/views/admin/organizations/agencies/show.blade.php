...
@section('title', __('words.show_agency'))
@section('content')
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb {{app()->getLocale() == 'ar' ? 'float-sm-left' :  'float-sm-right'}}">
                            ...
                            <li class="breadcrumb-item active">{{__('words.show_agency')}}</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
