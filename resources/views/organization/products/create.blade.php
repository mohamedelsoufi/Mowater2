...
@section('title', __('words.new_product'))
@section('content')
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb {{app()->getLocale() == 'ar' ? 'float-sm-left' :  'float-sm-right'}}">
                            ...
                            <li class="breadcrumb-item active">{{__('words.new_product')}}</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        ...
                        <div class="card card-danger">
                            <div class="card-header">
                                <h3 class="card-title">{{__('words.new_product')}}</h3>
                            </div>
                            <form action="{{route('organization.products.store')}}" method="POST" autocomplete="off"
                                        ...
                                        <div class="form-row mb-3">
                                            <div class="form-group col-md-3">
                                                ...
                                                <select name="is_new"
                                                    ...
                                                    <option
                                                        value="1" {{old('is_new') == "1" ? "selected" : ""}}>{{__('words.new')}}
                                                    </option>
                                                    <option
                                                        value="0" {{old('is_new') == "0" ? "selected" : ""}}>{{__('words.used')}}
                                                    </option>
                                                </select>
                                                @error('is_new')
                                                <span class="invalid-feedback" role="alert">
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <select name="type"
                                                    ...
                                                    <option
                                                        value="original" {{old('type') == "original" ? "selected" : ""}}>{{__('words.original')}}
                                                    </option>
                                                    <option
                                                        value="commercial" {{old('type') == "commercial" ? "selected" : ""}}>{{__('words.commercial')}}
                                                    </option>
                                                </select>
                                                @error('type')
                                                <span class="invalid-feedback" role="alert">
