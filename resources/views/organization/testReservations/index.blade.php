...
@section('title', __('words.show_tests_reservations'))
@section('content')
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb {{app()->getLocale() == 'ar' ? 'float-sm-left' :  'float-sm-right'}}">
                            ...
                            <li class="breadcrumb-item active">{{__('words.show_tests_reservations')}}</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">{{__('words.show_tests_reservations')}}</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td class="action">
                                                @if(auth('web')->user()->hasPermission(['read-tests-' . $record->name_en]))
                                                    <a href="{{route('organization.tests.show',$reservation->id)}}"
