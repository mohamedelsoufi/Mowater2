                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb {{app()->getLocale() == 'ar' ? 'float-sm-left' :  'float-sm-right'}}">
                            ...
                            <li class="breadcrumb-item active">{{__('words.new_ad')}}</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card card-danger">
                            ...
                            <form action="{{route('organization.ads.store')}}" method="POST" autocomplete="off"
                                                ...
                                                <select name="module_type" id="module_type"
                                                    ...
                                                    @foreach($modules as $key => $module)
                                                        <option value="{{$key}}" data-relation="{{$module}}"
                                                            {{ old('module_type') == $key ? "selected" : "" }}>{{__('words.' . $module)}}</option>
                                                    @endforeach
                                                </select>
                                                @error('module_type')
                                                <span class="invalid-feedback" role="alert">
...
@section('scripts')
    <script>
        {{--        {{ old('ad_type_id') == 4 ? "d-none" : "d-block"}}--}}
        if("{{old('ad_type_id') == 4}}"){
        ...
        $('#module_type').on('change', function () {
            // alert($(this).find(':selected').attr('data-relation'));
            getModule();
        });
