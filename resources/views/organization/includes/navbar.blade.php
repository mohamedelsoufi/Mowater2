...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <a href="{{route('organization.home')}}" class="nav-link">{{__('words.home')}}</a>
        </li>
{{--        <li class="nav-item d-none d-sm-inline-block">--}}
...
{{--        </li>--}}
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{route('organization.logout')}}" data-toggle="tooltip" title="{{__('words.logout')}}" role="button">
