...
@section('title', __('words.edit_branch_user'))
@section('content')
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb {{app()->getLocale() == 'ar' ? 'float-sm-left' :  'float-sm-right'}}">
                            ...
                            <li class="breadcrumb-item"><a
                                    href="{{route('organization.org-branches-users.index')}}">{{__('words.show_users')}}</a></li>

                            <li class="breadcrumb-item active">{{__('words.edit_branch_user')}}</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        ...
                        <div class="card card-danger">
                            <div class="card-header">
                                <h3 class="card-title">{{__('words.edit_branch_user')}}</h3>
                            </div>
                            <form method="post" action="{{route('organization.org-branches-users.update',$user->id)}}" autocomplete="off"
