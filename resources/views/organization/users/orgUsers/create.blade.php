...
@section('title', __('words.new_user'))
@section('content')
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb {{app()->getLocale() == 'ar' ? 'float-sm-left' :  'float-sm-right'}}">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('organization.users.index')}}">{{__('words.show_users')}}</a></li>
                            <li class="breadcrumb-item active">{{__('words.new_user')}}</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        ...
                        <div class="card card-danger">
                            <div class="card-header">
                                <h3 class="card-title">{{__('words.new_user')}}</h3>
                            </div>
                            <form action="{{route('organization.users.store')}}" method="POST" autocomplete="off"
