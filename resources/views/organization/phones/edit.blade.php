...
@section('title', __('words.edit_phone'))
@section('content')
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb {{app()->getLocale() == 'ar' ? 'float-sm-left' :  'float-sm-right'}}">
                            ...
                            <li class="breadcrumb-item active">{{__('words.edit_phone')}}</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        <div class="card card-danger">
                            <div class="card-header">
                                <h3 class="card-title">{{__('words.edit_phone')}}</h3>
                            </div>
                            <form method="post" action="{{route('organization.phones.update',$phone->id)}}"
                                  autocomplete="off"
                                        ...
                                        <div class="form-row mb-3">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="title_ar" dir="rtl"
                                                       ...
                                                       value="{{ old('title_ar', $phone->title_ar) }}" placeholder="{{__('words.title_ar')}}">
                                                @error('title_ar')
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="title_en" dir="ltr"
                                                       ...
                                                       value="{{ old('title_en', $phone->title_en) }}" placeholder="Title">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <select name="country_code" id="single-select"
                                                    ...
                                                    @foreach(phoneCodes() as $key=>$value)
                                                        <option value="{{$key}}" {{old('country_code',$phone->country_code) == $key ? 'selected' : ''}}>{{$value}}</option>
                                                    @endforeach
                                                </select>
