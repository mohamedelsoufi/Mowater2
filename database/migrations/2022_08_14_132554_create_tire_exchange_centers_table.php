...
class CreateTireExchangeCentersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tire_exchange_centers', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('tire_exchange_centers');
    }
}
