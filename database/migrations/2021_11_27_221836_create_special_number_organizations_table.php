...
class CreateSpecialNumberOrganizationsTable extends Migration {

	public function up()
	{
		Schema::create('special_number_organizations', function(Blueprint $table) {
	...
	{
		Schema::drop('special_number_organizations');
	}
}
